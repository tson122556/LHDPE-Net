...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='yolo_01_1_主干加kk+桥接+LSK骨干.yaml', help='model.yaml path')
    ...
    parser.add_argument('--name', default='yolov9_src_VisDrone2019', help='save to project/name')
