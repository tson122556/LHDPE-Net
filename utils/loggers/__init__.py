...
class Loggers():
    ...
    def __init__(self, save_dir=None, weights=None, opt=None, hyp=None, logger=None, include=LOGGERS):
        ...
        self.keys = [
            ...
            'x/lr1',
            'x/lr2']  # params
        self.best_keys = ['best/epoch', 'best/precision', 'best/recall', 'best/mAP_0.5', 'best/mAP_0.75',
                          'best/mAP_0.5:0.95']
        for k in LOGGERS:
        ...
        #     s = f"{prefix}run 'pip install wandb' to automatically track and visualize YOLO 🚀
        #     runs in Weights & Biases"
        #     self.logger.info(s)
        if not clearml:
